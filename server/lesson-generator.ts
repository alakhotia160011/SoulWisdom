...
function generateStory(passageData: any): string {
  const storyTemplates = {
    ...
    "Wisdom and Simplicity": `In the final chapter of ${passageData.source}, Lao Tzu offers profound reflections on the nature of true wisdom: ${passageData.content}\n\nThese paradoxical statements reveal the heart of Taoist wisdom - that authentic truth often contradicts conventional expectations. Beautiful rhetoric may mask emptiness, while simple words carry profound meaning. Those who engage in endless arguments miss the point, while those who truly understand have no need to prove their knowledge.\n\nThe sage embodies this wisdom by embracing simplicity and humility. Rather than attempting grand gestures or seeking recognition, the wise person works quietly and naturally, accomplishing great things through small, consistent actions. This teaching reminds us that the most profound wisdom is often found in the simplest truths, and that true greatness comes not from forcing outcomes but from aligning with the natural flow of life.`,
    
    "Impermanence and Liberation": `From ${passageData.source}, the Buddha teaches one of the most fundamental truths of existence: ${passageData.content}\n\nThis profound teaching strikes at the heart of human suffering - our tendency to cling to what is inherently temporary. All conditioned existence, from our thoughts and emotions to our relationships and possessions, arises and passes away in an endless cycle of change.\n\nWhen we truly understand impermanence, we stop fighting against the natural flow of life. Instead of desperately grasping at fleeting pleasures or pushing away inevitable pain, we learn to observe with equanimity. This wisdom transforms our relationship to both joy and sorrow - we can appreciate beauty without being devastated by its passing, and endure hardship knowing it too shall change.\n\nThe path of purification begins with this recognition. As we release our attachments to the impermanent, we discover the peace that lies beyond the constant fluctuations of experience - a peace that no external circumstance can disturb.`,
    
    "Spiritual Blessedness": `In the opening of the Sermon on the Mount from ${passageData.source}, Jesus presents the revolutionary teachings known as ${passageData.title}: ${passageData.content}\n\nThese profound declarations overturn conventional understanding of happiness and success. In a world that celebrates wealth, power, and self-assertion, Jesus proclaims that true blessedness belongs to those who embrace poverty of spirit, mourning, and meekness.\n\nThe "poor in spirit" are those who recognize their complete dependence on divine grace - they have released the illusion of self-sufficiency that keeps so many trapped in spiritual poverty. Those who mourn are not simply sad, but deeply aware of the world's brokenness and their own need for healing. The meek are not weak, but possess the strength to respond to hostility with gentleness.\n\nEach beatitude reveals that the kingdom of heaven operates by different principles than earthly kingdoms. True fulfillment comes not from having our desires satisfied, but from aligning our hearts with divine will. When we hunger and thirst for righteousness with the same intensity we seek food and water, we discover a satisfaction that the world cannot provide.\n\nThis teaching transforms our understanding of what it means to live a blessed life - it is found not in external circumstances, but in the condition of our hearts.`,
    
    "Spiritual Accountability and Humility": `From ${passageData.source}, Rabbi Akavya offers one of the most penetrating teachings in Jewish wisdom: ${passageData.content}\n\nThis profound instruction presents three fundamental questions that cut through the illusions and distractions that cloud our spiritual vision. When we truly contemplate our origins, we remember that we came from dust and divine breath - we are both humble clay and sacred spirit.\n\nKnowing where we are going reminds us that our time here is temporary and precious. Death is not merely an ending but a return to our source, and this awareness transforms how we live each day. Every moment becomes an opportunity for growth, service, and connection.\n\nPerhaps most sobering is the third reflection - that we will give account before the Divine. This is not about fear or punishment, but about the profound responsibility that comes with consciousness. Every choice we make, every word we speak, every thought we entertain contributes to the cosmic web of cause and effect.\n\nWhen these three contemplations become part of our daily awareness, they serve as a spiritual compass that keeps us aligned with what truly matters. Ego dissolves in the face of such perspective, replaced by humility, purpose, and reverence for the sacred nature of existence.`,
    
    "Divine Compassion and Creation": `The opening verses of ${passageData.source}, known as ${passageData.title}, present one of the most beautiful revelations of divine nature: ${passageData.content}\n\nThese verses reveal that compassion is not merely an attribute of the Divine but the very foundation of existence itself. The word "Rahman" (The Compassionate) appears at the beginning, establishing that everything that follows flows from infinite mercy.\n\nThe teaching of the Qur'an is presented as the first gift of divine compassion - guidance for humanity's spiritual development. The creation of human beings follows, but notice that they are immediately granted the gift of speech. This is profound: we are created not just to exist, but to communicate, to express, to praise, and to connect with both the Divine and each other.\n\nThe verse then expands to cosmic proportions - the sun and moon in their precise orbits, the stars in their courses, and even the trees in their rooted worship. All of creation participates in a grand symphony of divine praise, each being contributing its own unique voice to the cosmic harmony.\n\nThis teaching transforms our understanding of our place in creation. We are not separate from nature but part of an interconnected web of worship and gratitude. Every sunrise, every tree swaying in the wind, every moment of human speech becomes an invitation to join this universal chorus of divine appreciation.`,
    
    "Compassion and Non-Violence": `From ${passageData.source}, the Buddha offers one of the most revolutionary insights in human history: ${passageData.content}\n\nThis simple yet profound teaching reveals a fundamental law of human experience that operates as reliably as gravity. When we respond to hatred with more hatred, we create an endless cycle of suffering that multiplies and spreads like wildfire. But when we meet hatred with love, we have the power to transform not only our own hearts but the hearts of others.\n\nThe Buddha calls this "the eternal rule" because it transcends time, culture, and circumstance. This is not merely idealistic philosophy but practical wisdom that has been tested by countless practitioners throughout history. Love has the unique power to dissolve the very foundation upon which hatred stands.\n\nThis teaching challenges our most basic instincts for revenge and retaliation. It asks us to be revolutionary in our response to those who hurt us. When someone acts from their pain and wounds to wound us, we have a choice: we can add our pain to theirs, creating more suffering, or we can respond with the compassion that recognizes the hurt behind their actions.\n\nPracticing this teaching transforms us into agents of healing in a world torn by conflict. Every moment we choose love over hatred, understanding over judgment, we participate in breaking cycles that may have persisted for generations.`
  };
